...
namespace Backend5.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Price")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Price")] Insurance insurance)
        {
            if (id != insurance.Id)
            {
                return NotFound();
